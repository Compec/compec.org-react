	...
	return(
		<div className="container AltKurulAnket">
			...
			<div className="card">
				...
				<input className="checkBox" type="checkbox" value="LCMK7I7PQX4QKfRlIBJN" name="algo" /> C++ ile ALGO101 <br/><br/>
				<input className="checkBox" type="checkbox" value="fTLZJZE2NHEzYRxyyZjz" name="java" /> Java <br/><br/>
				<input className="checkBox" type="checkbox" value="AquuRO9TM4heaXTQ8Bbz" name="python" /> Python <br/><br/>
				<input className="checkBox" type="checkbox" value="JFFbaCCQrX5VU2yt9zjc" name="webdev" /> Web Geliştirme <br/><br/>
				<input className="checkBox" type="checkbox" value="B59aA3E8LrwiuDqPtm2j" name="unity" /> Unity ile Oyun Geliştirme <br/><br/>
