...
function Playit() {
	return (
		<div class="container">
			<Helmet>
				<title>PlayIT - Boğaziçi Üniversitesi Bilişim Kulübü</title>
				<meta 
					name="description"
					content="PlayIT oyun geliştirme tutkunlarını ve oyun şirketlerini bir araya getirirken atölyeler ve 24 saatlik GameJam ile eşsiz bir deneyim elde ediyor."
				/>
			</Helmet>
