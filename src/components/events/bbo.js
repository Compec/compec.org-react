...
function BBO() {
	return (
		<div class="container">
			<Helmet>
				<title>Boğaziçi Bilişim Ödülleri - Boğaziçi Üniversitesi Bilişim Kulübü</title>
				<meta 
					name="description"
					content="Boğaziçi Bilişim Ödülleri, 2014'ten bu yana her yıl bilişim ve teknoloji alanında profesyonellerin ve kurumların 
					ödüllendirildiği bir ödül törenidir."
				/>
			</Helmet>
			...
			<div class="row">
				<div class="col">
					<h1>Boğaziçi Bilişim Ödülleri.</h1><br/>
					<p>
