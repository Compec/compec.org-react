					...
					<div className="row">
						...
						<div className="col-md-12">
							<div class="template-demo">
								...
								<a href="http://facebook.com/bouncompec" target="_blank" rel="noopener noreferrer">
									<button type="button" class="btn btn-social-icon btn-facebook">
										<i class="fa fa-facebook"></i>
									</button>
								</a>

								<a href="https://www.youtube.com/user/compecboun" target="_blank" rel="noopener noreferrer">
									<button type="button" class="btn btn-social-icon btn-youtube">
										<i class="fa fa-youtube-play"></i>
									</button>
								</a>

								<a href="http://twitter.com/bouncompec" target="_blank" rel="noopener noreferrer">
									<button type="button" class="btn btn-social-icon btn-twitter">
										<i class="fa fa-twitter"></i>
									</button>
								</a>

								<a href="https://github.com/Compec" target="_blank" rel="noopener noreferrer">
									<button type="button" class="btn btn-social-icon btn-github">
										<i class="fa fa-github"></i>
									</button>
								</a>

								<a href="https://www.linkedin.com/company/bouncompec" target="_blank" rel="noopener noreferrer">
